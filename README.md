...
**[🚀 Live Demo](https://churn-prediction-dashboard-ujetpgon5n2lulk6fmmhwg.streamlit.app/)** | **[📊 View Code](https://github.com/shreyeshi-somya/churn-prediction-dashboard/tree/main/notebooks)**
...
- **📊 Multi-Model Comparison**: Choose between 4 different ML models from the sidebar
- **📦 Built-in Sample Dataset**: Use the included Telco Churn dataset (7,043 customers) or upload your own CSV
- **🎯 Batch Predictions**: Upload CSV files for bulk customer predictions with risk level categorization (High/Medium/Low)
- **📈 Performance Metrics**: Interactive confusion matrices, ROC curves, and key metrics (Accuracy, Precision, Recall, F1-Score)
- **🤖 AI-Powered Insights**: Business recommendations generated by Claude AI
- **💾 Downloadable Results**: Export predictions as CSV
- **🗂️ Tabbed Interface**: Organized into Make Predictions, Model Performance, and AI Insights tabs
